...
!ifdef RUNASADMIN & NONELEVATED
	!verbose push 3
	!insertmacro _SEV_Var
	${ReadUserConfig} $_SEV_ExecAsAdmin ExecAsAdmin
	${If} $_SEV_ExecAsAdmin == true
	!verbose pop
!endif
		!verbose push 3
		!ifdef VAL
...
!ifdef RUNASADMIN & NONELEVATED
	!verbose push 3
	${Else}
		${WriteINIStr} $APPDIRECTORY\Bin\appexecutor.ini Environment "${_VAR}" "${_VAL}"
	${EndIf}
	!verbose pop
!endif
!macroend
